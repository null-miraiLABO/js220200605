...
window.onload = function () {
    ...
    game.preload("boy_walk(250360).png");
    ...
    game.onload=function(){
        ...
        //Spriteオブジェクトを生成します
        boy_walk(250360)=new Sprite(250,360);
        //Spriteオブジェクトに「こぶた」の画像を
        boy_walk(250360).image=game.assets['boy_walk(250360).png'];
        //Spriteオブジェクトのフレームに1を設定します
        boy_walk(250360).frame=1;
        //Spriteの位置座標を設定します
        boy_walk(250360).x=200;
        boy_walk(250360).y=200;
        ...
        game.rootScene.addChild(player);
          ...
          //boy
        boy_walk(250360).addEventListener('enterframe',function(){
        this.frame=game.frame%2;
        if(pad.isTouched){
          this.x+=pad.vx*4;
          this.y+=pad.vy*4;
      ...
      game.rootScene.addChild(boy_walk(250360));
